test_that("pollr_analyse works with a valid input", {

  pollr_analyse_results <- pollr_analyse(
...
test_that("pollr_analyse fails with invalid inputs", {

  expect_error(
    pollr_analyse(survey_data = df_survey, question_varname = "A5"),
    "Variable `A5` not found in `survey_data`."
  )

  expect_error(
    pollr_analyse(survey_data = df_survey, question_varname = 3),
