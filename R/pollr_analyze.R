...
#' @param question_text A character string, the text of the question (optional)
...
#'   \item{data}{A survey design of data question}
#'   \item{info}{A list with all informations about the question}
...
pollr_analyse <- function(survey_data,
  ...
  check_pollr_analyze_inputs(survey_data, question_varname, weight_varname, cross_varname,  question_text, sorted_results)

  question_info <- pollr_analyze_info(survey_data, question_varname, weight_varname, cross_varname, question_text, sorted_results)
